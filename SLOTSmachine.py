...
ROWS = 3
COLS = 3
#improve by adding functions to break or add option to deposit more money when all money is used
#allow player to win when any of the lines is correct
#check the winning system again
symbol_count = {
    "A": 2,
    "B": 4,
    "C": 6,
...
def deposit():
    ...
    print("You have deposited £" + str(amount) + " into your balance")
    return amount
...
def spin(balance):
    ...
    slots = get_slot_machine_split(ROWS, COLS, symbol_count)
    print_slot_machine(slots)
    winnings, winning_lines = check_winnings(slots, lines, bet, symbol_value)
    print(f" You won £{winnings}")
    print(f" winnings lines were :", *winning_lines)
